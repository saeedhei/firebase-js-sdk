...
type Subscribe<T> = (next: NextFn<T>|{[name: string] : string | null},
...
export class Observer<T> {
  ...
  constructor(nextOrObserver: NextFn<T>|{[name: string] : string | null}|null,
              opt_error?: ErrorFn|null, opt_complete?: CompleteFn|null) {
