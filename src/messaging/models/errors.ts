...
const ERROR_MAP = {
  ...
  [CODES.PERMISSION_DEFAULT] :
      'The required permissions were not granted and ' +
          'dismissed instead.',
  ...
  [CODES.SW_REG_REDUNDANT] :
      'The service worker being used for push was made ' +
          'redundant.',
...
export default {codes : CODES, map : ERROR_MAP};
