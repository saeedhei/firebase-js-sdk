...
export const base64 = {
   ...
   * @type {string}
   */
  ENCODED_VALS_BASE : 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' +
  ...
  encodeByteArray(input, opt_webSafe?) {
    ...
    var byteToCharMap =
        opt_webSafe ? this.byteToCharMapWebSafe_ : this.byteToCharMap_;
   ...
   * decodes to one byte.  If the group has three characters, it decodes to two
   * bytes.
   *
  ...
  decodeStringToByteArray(input, opt_webSafe) {
    ...
    var charToByteMap =
        opt_webSafe ? this.charToByteMapWebSafe_ : this.charToByteMap_;
