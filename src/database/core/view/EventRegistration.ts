...
export class ValueEventRegistration implements EventRegistration {
   ...
   */
  constructor(
    private callback_: ((d: DataSnapshot) => any) | null,
    private cancelCallback_: ((e: Error) => any) | null,
...
export class ChildEventRegistration implements EventRegistration {
  ...
  constructor(
    private callbacks_:
      | ({ [k: string]: (d: DataSnapshot, s?: string | null) => any })
      | null,
    private cancelCallback_: ((e: Error) => any) | null,
  ...
  getEventRunner(eventData: CancelEvent | DataEvent): () => void {
    ...
    if (eventData.getEventType() === "cancel") {
      ...
      return function() {
        cb.call(
          ctx,
          (<DataEvent>eventData).snapshot,
          (<DataEvent>eventData).prevName
        );
      };
    }
  }
