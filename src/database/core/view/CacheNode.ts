...
export class CacheNode {
   ...
   */
  constructor(private node_: Node, private fullyInitialized_: boolean,
              private filtered_: boolean) {}

  /**
   * Returns whether this node was fully initialized with either server data or
   * a complete overwrite by the client
   * @return {boolean}
   */
  isFullyInitialized(): boolean { return this.fullyInitialized_; }

  /**
   * Returns whether this node is potentially missing children due to a filter
   * applied to the node
   * @return {boolean}
   */
  isFiltered(): boolean { return this.filtered_; }
   ...
   * @return {!Node}
   */
  getNode(): Node { return this.node_; }
}
