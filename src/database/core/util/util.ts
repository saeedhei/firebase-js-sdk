...
export const enableLogging = function(logger, opt_persistent?) {
  assert(
    !opt_persistent || (logger === true || logger === false),
  ...
  if (logger === true) {
    ...
    if (opt_persistent) SessionStorage.set("logging_enabled", true);
...
export const error = function(var_args) {
  if (typeof console !== "undefined") {
    var message =
      "FIREBASE INTERNAL ERROR: " + buildLogMessage_.apply(null, arguments);
