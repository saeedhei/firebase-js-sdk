...
export interface TransportConstructor {
  new(connId: string, repoInfo: RepoInfo, transportSessionId?: string,
      lastSessionId?: string): Transport;
  isAvailable: () => boolean;
...
export abstract class Transport {
   ...
   * @interface
   */
  constructor(connId: string, repoInfo: RepoInfo, transportSessionId?: string,
   ...
   */
  abstract open(onMessage: (a: Object) => void,
                onDisconnect: (a?: boolean) => void): void;
...
export interface TransportConstructor {
  new(connId: string, RepoInfo, transportSessionId?: string,
      lastSessionId?: string);
}
