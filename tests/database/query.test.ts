...
import { getQueryValue, getRandomNode, getPath, pause } from "./helpers/util";
import {
  EventAccumulator,
...
describe("Query Tests", function() {
  ...
  it("Query.isEqual works.", function() {
    ...
    var childQueryStartAt1EndAt2 = childQueryOrderedByTimestamp
      .startAt(1)
      .endAt(2);
  ...
  it(".on() with a context works.", function() {
    ...
    var ListenerDoohickey = function() {
      this.snap = null;
    };
