...
import {LLRBNode, SortedMap} from "../../src/database/core/util/SortedMap";
...
describe("SortedMap Tests", function() {
  ...
  it("Removal bug", function() {
    const map =
        new SortedMap(defaultCmp).insert(1, 1).insert(2, 2).insert(3, 3);
  ...
  it("Rotate left leaves the tree in a valid state", function() {
    const node = new LLRBNode(
        4, 4, false, new LLRBNode(2, 2, false, null, null),
        new LLRBNode(7, 7, true, new LLRBNode(5, 5, false, null, null),
  ...
  it("Rotate right leaves the tree in a valid state", function() {
    const node = new LLRBNode(
        7, 7, false,
        new LLRBNode(4, 4, true, new LLRBNode(2, 2, false, null, null),
