...
describe('Firebase Messaging > new *Controller()', function() {
  it('should handle bad input', function() {
    const badInputs = [
      makeFakeApp(), makeFakeApp({messagingSenderId : {}}),
      makeFakeApp({messagingSenderId : []}),
      makeFakeApp({messagingSenderId : true}),
      makeFakeApp({messagingSenderId : 1234567890})
    ];
  ...
  it('should be able to handle good input', function() {
    const app = makeFakeApp({messagingSenderId : '1234567890'});
